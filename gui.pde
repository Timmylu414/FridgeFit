...
public void createGUI(){
  ...
  healthinessSlider = new GSlider(window1, 197, 165, 100, 55, 10.0);
  ...
  shoppingFrequencySlider = new GSlider(window1, 197, 251, 100, 58, 10.0);
  ...
  spoilRateSlider = new GSlider(window1, 195, 77, 100, 55, 10.0);
